 ...
 *
 * Included libraries:
 *  jQuery 3.6.0, DataTables 1.11.4
 */
...
(function (l) {
    ...
    function ma(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && d && "Keine Daten verfügbar" === b.sEmptyTable && X(a, a, "sZeroRecords", "sEmptyTable");
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sInfoFiltered: "(gefiltertet von _MAX_ Einträgen)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
    ...
    u.ext = M = {
        buttons: {},
        classes: {},
        builder: "bs5/jq-3.6.0/dt-1.11.4",
        errMode: "alert",
        feature: [],
        search: [],
        selector: {
