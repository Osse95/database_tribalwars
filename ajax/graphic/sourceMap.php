...
if (!graphicControl::checkSourceMap($World_User->getWorldVersion())) {
    $worldMap = new worldMap($World_User->getWorldVersion(), $World_User->getPlayerID());
    $worldMap->selectMapType("sourceMap");
    $worldMap->createMap();
    $worldMap->safeImage("sourceMap");
}
graphicControl::getSourceMap($World_User->getWorldVersion());